    ...
    <div className='min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
        <div className='flex flex-wrap items-center gap-5'>
          <div className='flex items-center gap-3 shadow border border-blue-500 p-4 w-60 rounded-md'>
          ...
          <div className='flex items-center gap-3 shadow border border-blue-500 p-5 w-56 rounded-md'>
